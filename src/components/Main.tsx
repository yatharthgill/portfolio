    ...
    <>
      <div className=" md:min-h-[70vh] md:px-36 md:py-7 flex w-full justify-center items-center relative">
        <div className="left w-full lg:w-1/2 flex flex-col text-2xl sm:text-4xl md:text-5xl text-start items-start justify-center leading-normal pl-10">
          <div className="name">
            Hi, My Name is
            <span className="text-[#00FFFF]"> Yatharth</span>
          </div>
          <div> and I am a passionate </div>
          <div className="inline-flex gap-1 min-w-[200px]">
            <span id="element" className="text-[#00FFFF] whitespace-nowrap" />
          </div>
          <div className="description text-sm w-[75vw] sm:w-[50vw] lg:w-auto text-justify leading-6 mt-3">
            <p>
              ...
              like <strong className="text-[#00FFFF]">MERN </strong>stack and
              frameworks like{" "}
              <strong className="text-[#00FFFF]">Next.Js</strong>, with a focus
          ...
          <div className=" popup flex gap-8 justify-end mt-10">
            <div className="  w-28 h-8 py-6 rounded-full  flex justify-center items-center text-xl shadow-[0px_0px_10px_#00FFFF] hover:shadow-[0px_0px_20px_#00FFFF] transition-all duration-300 ease-in-out hover:scale-110">
              <Link
