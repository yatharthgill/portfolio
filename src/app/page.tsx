...
export default function Home() {
  ...
  return (
    <>
      <div className="min-h-[70vh] md:px-36 md:py-7 flex w-full justify-center items-center relative">
      ...
      <div className="popup flex gap-4 justify-end  md:px-36 absolute inset-x-0 bottom-0 mt-44">
        <div className="md:h-28 w-28 h-8 py-6 rounded-full bg-[#E00FE0] flex justify-center items-center text-xl font-semibold box shadow-[0px_0px_10px_#E00FE0] dark:shadow-[0px_0px_20px_#E00FE0">
          <Link href="/contact">Contact</Link>
        </div>

        <div className="md:h-28 w-28 h-8 py-6  rounded-full bg-[#E00FE0] flex justify-center items-center text-xl font-semibold box shadow-[0px_0px_10px_#E00FE0] dark:shadow-[0px_0px_20px_#E00FE0]">
          <Link href="https://drive.google.com/file/d/1NrTh3IxPXp86aPCt1jNYl5ZhKD2ax2Cz/view?usp=drive_linkf">Resume</Link>
